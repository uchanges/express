...
```shell
$ composer require uchanges/express -vvv
```
## 配置
...
### 快递100
```php
use Uchanges\Express\Express100;
...
### 快递鸟
```php
use Uchanges\Express\ExpressBird;
...
```
 ...
 可以用两种方式来获取 `Uchanges\Express\Express` 实例：
